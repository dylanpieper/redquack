...
reach your memory limit during import. **redquack’s solution to this
error is to store the data on disk in a database rather than in RAM,
allowing you to work with the data in R without loading it all into
memory at once.**
